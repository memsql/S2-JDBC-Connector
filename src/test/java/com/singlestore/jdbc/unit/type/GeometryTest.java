...
package com.singlestore.jdbc.unit.type;
...
public class GeometryTest {
  ...
  public void testPointEncoding() throws SQLException {
    ...
    ReadableByteBuf readBuf = new ReadableByteBuf(new MutableInt(), ptBytes, ptBytes.length);
  ...
  public void testLineStringEncoding() throws SQLException {
    ...
    //    ReadableByteBuf readBuf = new ReadableByteBuf(new MutableInt(), lineBytes,
    // lineBytes.length);
    ...
    //    assertEquals(geo, geo);
    //    assertEquals(
    //        new LineString(new Point[] {new Point(0, 0), new Point(0, 10), new Point(10, 0)},
    // true),
    //        geo);
    //    assertEquals(
    //        new LineString(new Point[] {new Point(0, 0), new Point(0, 10), new Point(10, 0)},
    ...
    //    assertNotEquals("wrong", geo);
    //    assertNotEquals(
    //        new LineString(new Point[] {new Point(1, 0), new Point(0, 10), new Point(10, 0)},
    // true),
    //        geo);
  }
  ...
  //        new Polygon(
  //            new LineString[] {
  //              new LineString(new Point[] {new Point(1, 1), new Point(1, 5), new Point(1, 1)},
  // false)
  //            }),
  //        geo);
  //  }
  ...
  //    Geometry geo = Geometry.getGeometry(readBuf, ptBytes.length, null);
  //    assertEquals(
  //        "GEOMETRYCOLLECTION(POINT(2.0 4.0),LINESTRING(0.0 0.0,0.0 10.0,10.0 0.0))",
  // geo.toString());
  ...
  public void testWrongEncoding() throws SQLException {
    ...
    assertNull(
        Geometry.getGeometry(new ReadableByteBuf(new MutableInt(), new byte[0], 0), 0, null));
  }
}
