...
public class FloatArrayCodecTest extends CommonCodecTest {
  ...
  public static void drop() throws SQLException {
    ...
    stmt.execute("DROP TABLE IF EXISTS FloatArrayCodec");
  }
  ...
  public static void beforeAll2() throws SQLException {
    ...
    Statement stmt = sharedConn.createStatement();
    stmt.execute(
        "CREATE ROWSTORE TABLE FloatArrayCodec (t0 int not null primary key auto_increment, t1 blob) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci");
  ...
  public void floatArray() throws SQLException {
    Statement stmt = sharedConn.createStatement();
    stmt.execute("TRUNCATE TABLE FloatArrayCodec");
  ...
  private void floatArray(Connection con) throws SQLException {
    ...
    try (PreparedStatement prep =
        con.prepareStatement("INSERT INTO FloatArrayCodec(t1) VALUES (?)")) {
      prep.setObject(1, val);
      prep.execute();
    }
    try (PreparedStatement prep =
        con.prepareStatement("SELECT * FROM FloatArrayCodec order by t0")) {
  ...
  private void floatArrayArrayObj(Connection con) throws SQLException {
    float[] val = new float[] {1, 2, 3};
    ...
    byte[] expectedConverstion =
        new byte[] {0x00, 0x00, (byte) 0x80, 0x3F, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x40, 0x40};
    try (PreparedStatement prep =
        con.prepareStatement("INSERT INTO FloatArrayCodec(t0, t1) VALUES (?, ?)")) {
      prep.setInt(1, 1);
    ...
    try (PreparedStatement prep =
        con.prepareStatement(
            "SELECT * FROM FloatArrayCodec order by t0",
  ...
  private void floatArrayArrayObjWithType(Connection con) throws SQLException {
    float[] val = new float[] {1, 2, 3};
  ...
  private void floatArrayObjArray(Connection con) throws SQLException {
