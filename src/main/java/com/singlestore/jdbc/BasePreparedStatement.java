...
import com.singlestore.jdbc.plugin.codec.FloatObjectArrayCodec;
...
public abstract class BasePreparedStatement extends Statement implements PreparedStatement {
   ...
   * @param canCachePrepStmts can cache prepared statement
    ...
    if (targetSqlType != null) {
      ...
      if (obj instanceof String || obj instanceof Character) {
        ...
        if (targetSqlType == Types.BINARY
          ...
          setBlob(parameterIndex, new SingleStoreBlob((byte[]) obj));
        } else {
          throw exceptionFactory()
